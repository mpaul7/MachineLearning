...
def multi_dot(arrays):
    ...
    .. [1] Cormen, "Introduction to PredictiveModelingSteps", Chapter 15.2, p. 370-378
...
def _multi_dot_matrix_chain_order(arrays, return_costs=False):
    ...
    The implementation CLOSELY follows Cormen, "Introduction to PredictiveModelingSteps",
