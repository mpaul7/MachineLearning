...
if __name__ == '__main__':
	...
	# generateDataDetails(dataset='Solana2020d',
	#                     dataset_path=r"D:\DataSets\Solana2020d",
	#                     result_path=r"C:\Users\Owner\mltat\data\mltat\TestFiles\train_test\Solana2020c\all_dataset",
	#                     feat_train_path=r"D:\DataSets\TestFiles\train_test\Solana-5G\splits\80-20percent\all-data_train",
	#                     feat_test_path=r"D:\DataSets\TestFiles\train_test\Solana-5G\splits\80-20percent\all-data_test",
	#                     percentage=80
	#                     )
	generateDataDetails(dataset='Solana2020a',
	                    dataset_path=r"D:\Data\DataSets\Solana2020a",
	                    result_path=r"D:\Data\TestFiles\train_test_splits\Solana2020a\all_dataset",
	                    feat_train_path=r"D:\Data\TestFiles\train_test_splits\Solana2020a\splits\80-20percent\all-data_train-2",
	                    feat_test_path=r"D:\Data\TestFiles\train_test_splits\Solana2020a\splits\80-20percent\all-data_test-2",
	                    percentage=80
	                    )